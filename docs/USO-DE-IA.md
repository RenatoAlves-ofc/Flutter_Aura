...
| Escreveu os 67 testes | Testou em aparelho real — só o autor tinha o celular |
...
|---|---|---|
| `analyze` + 67 testes | regras de negócio, serialização, resiliência | qualquer coisa visual |
