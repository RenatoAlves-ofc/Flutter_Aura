...
| Escreveu os 101 testes | Testou em aparelho real — só o autor tinha o celular |
...
|---|---|---|
| `analyze` + 101 testes | regras de negócio, serialização, resiliência | qualquer coisa visual |
